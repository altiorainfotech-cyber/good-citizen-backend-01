...
export class AppController {
  ...
  async verify_otp(@Body() dto: OtpDto, @Req() req: Request) {
  ...
  async reset_forgot_password(
    @Body() dto: ResetForgotPassword,
    @Req() req: Request,
  ) {
  ...
  @ApiConsumes('application/json', 'application/x-www-form-urlencoded')
  @ApiOperation({ summary: `User profile Api` })
  async edit_profile(@Body() dto: UpdateUserDto, @Req() req: Request) {
    return await this.appService.update_profile(dto, req.user);
  }

  /**
   * Will handle the user / driver content listing controller logic
  ...
  @Get('content')
  @ApiConsumes('application/json', 'application/x-www-form-urlencoded')
  @ApiOperation({ summary: `User/Driver get content Api` })
  async content(@Query() dto: GetContent) {
    return await this.appService.content(dto);
  }
  ...
  @ApiConsumes('application/json', 'application/x-www-form-urlencoded')
  @ApiOperation({ summary: `User/Driver delete  account Api` })
  async delete_account(@Req() req: Request) {
    return await this.appService.delete_account(req.user);
  }
}
